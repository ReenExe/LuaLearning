...
describe('query filter key', function()
    it('do', function()
        ...
        assert.same(getQueryFilterKey({b = 'puma'}, {cookie_sort = 'prices'}), '?page=1&sort=prices&b=puma')
        assert.same(getQueryFilterKey({b = 'puma'}, {cookie_sort = {'prices'}}), '?page=1&sort=views&b=puma')
